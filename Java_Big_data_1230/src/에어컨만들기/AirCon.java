...
// - 에어컨의 동작은 Scanner로 특정 문자를 입력받아 동작 시킴
// - 현재 온도 표시를 위해 캘린더 API를 이용해서 해당 달의 적절한 온도를 가져오도록 구현
// - 현재 온도와 설정 온도가 같아지면 자동 종료
public class AirCon {
    private boolean isPower; //전원 온오프
    private int setTemp; //온도 설정 기능
    private int currTemp; //현재 온도 표시 기능
    private boolean isCooler; //에어컨 냉방기 온오프
    private boolean isHeater; //에어컨 난방기 온오프
    private int widStep; //1단, 2단, 3단
    ...
    public void airConInfo() {
        ...
        System.out.println("바람 세기 : " + windStr[widStep]);
    }
